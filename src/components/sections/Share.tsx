  ...
  const handleShareKakao = () => {
    window.Kakao.Share.sendDefault({
      ...
      content: {
        ...
        description: `${(format(parseISO(weddingDate), 'M월 d일 eeee aaa h시'), { locale: ko })}`,
        imageUrl:
          'https://www.google.com/url?sa=i&url=https%3A%2F%2Fkr.freepik.com%2Fpremium-vector%2Fcute-asian-groom-bride-characters-flat-design-style-vector-illustration_27250240.htm&psig=AOvVaw04txitEVKoIJo21VODCLnj&ust=1740116209227000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCIDiiZvE0YsDFQAAAAAdAAAAABAE',
        link: {
